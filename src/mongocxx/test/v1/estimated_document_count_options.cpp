...
TEST_CASE("ownership", "[mongocxx][v1][estimated_document_count_options]") {
    estimated_document_count_options source;
    estimated_document_count_options target;
...
TEST_CASE("default", "[mongocxx][v1][estimated_document_count_options]") {
    estimated_document_count_options const opts;
...
TEST_CASE("max_time", "[mongocxx][v1][estimated_document_count_options]") {
    ...
    CHECK(estimated_document_count_options{}.max_time(v).max_time() == v);
}

TEST_CASE("comment", "[mongocxx][v1][estimated_document_count_options]") {
    ...
    CHECK(estimated_document_count_options{}.comment(v).comment() == v);
}

TEST_CASE("read_preference", "[mongocxx][v1][estimated_document_count_options]") {
